...
if (!window.carouselLoaded) {
  ...
  carouselId = document.getElementById("carousel");
  carouselItems = carouselId?.getElementsByClassName("flex")[0];
  carouselContainer = carouselId?.getElementsByClassName("container")[0];
